...
public final class FileOpenError extends Table {
  ...
  public static int createFileOpenError(FlatBufferBuilder builder,
      int errno_value,
      int msgOffset) {
    builder.startObject(2);
    FileOpenError.addMsg(builder, msgOffset);
    FileOpenError.addErrnoValue(builder, errno_value);
    return FileOpenError.endFileOpenError(builder);
  }

  public static void startFileOpenError(FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endFileOpenError(FlatBufferBuilder builder) {
